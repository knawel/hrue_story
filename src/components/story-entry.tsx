  ...
  return (
    <>
      <button
        ...
        onClick={toggle}
        className="absolute -left-[37px] top-1.5 size-2 rounded-full bg-silver focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand"
      />
      <div className="rounded-lg border bg-transparent">
        <button
          ...
          aria-expanded={expanded}
          onClick={toggle}
          className="flex w-full flex-wrap items-baseline gap-x-2 gap-y-1 px-4 py-2 text-left text-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand"
        >
